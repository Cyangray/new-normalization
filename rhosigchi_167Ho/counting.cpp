{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.756000,7.820000,50,0.535678,72495936.000000);
   ...
   float Bn[1]={7.280000};
   float Bnerr[1]={0.001};
   float rho_Bn[1]={7249594.000000};
   float rho_Bnerr[1]={3947051.750000};
   int i = 0;
   float a0 =  -0.7560;
   float a1 =   0.1280;
   float x,y,z;
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    6.256,3.625e+07,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(-0.116000,199.103500,-0.116000,32.587234,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(0.524000,1049.054121,0.524000,171.698502,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(3.084000,206835.243262,3.084000,33852.687500,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(5.260000,7997435.672576,5.260000,1308938.875000,0.02,">");
   arrow4->Draw();
   c1->Update();
