{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.843336,   7.117,50,6.898e+01,1.062e+08);
   ...
   TArrow *arrow1 = new TArrow(1.355e+00,2.780e+04,1.355e+00,4.379e+03,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(1.477e+00,4.765e+04,1.477e+00,7.506e+03,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(4.163e+00,3.351e+06,4.163e+00,5.279e+05,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(4.652e+00,6.456e+06,4.652e+00,1.017e+06,0.02,">");
   arrow4->Draw();
   c1->Update();
   c1->Print("sigext.pdf");
   c1->Print("sigext.eps");
