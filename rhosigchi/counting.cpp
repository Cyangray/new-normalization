{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.843336,6.727608,50,12.411949,29598198.000000);
   ...
   float Bn[1]={6.243640};
   float Bnerr[1]={0.001};
   float rho_Bn[1]={2959819.750000};
   float rho_Bnerr[1]={139038.156250};
   int i = 0;
   float a0 =  -0.8433;
   float a1 =   0.1221;
   float x,y,z;
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    5.382,1.480e+07,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(0.133560,1442.538950,0.133560,258.226624,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(0.499896,3478.073026,0.499896,622.604370,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(3.064248,577088.414843,3.064248,103303.687500,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(4.651704,8275683.870307,4.651704,1481417.125000,0.02,">");
   arrow4->Draw();
   c1->Update();
